...
const installEslintPrettierDependencies = ({ dir }: { dir: string }) => {
  ...
  // eslint-disable-next-line no-console
  console.log(
    '\n📦 Installing ESLint, Prettier, and @ttoss/config dependencies...'
  );
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.log(
      '✓ Installed eslint, prettier, @ttoss/eslint-config, and @ttoss/config'
    );
    return true;
  } catch (error) {
    // eslint-disable-next-line no-console
...
const installHuskyDependencies = ({ dir }: { dir: string }) => {
  ...
  // eslint-disable-next-line no-console
  console.log('\n📦 Installing Husky, commitlint, and lint-staged...');
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.log('✓ Installed husky, @commitlint/cli, and lint-staged');
    return true;
  } catch (error) {
    // eslint-disable-next-line no-console
    console.error('✗ Failed to install dependencies:', error);
...
const installLernaDependencies = ({ dir }: { dir: string }) => {
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.log('✓ Installed @lerna-lite packages');
    return true;
  } catch (error) {
    // eslint-disable-next-line no-console
    console.error('✗ Failed to install dependencies:', error);
...
const installSyncpackDependency = ({ dir }: { dir: string }) => {
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.log('✓ Installed syncpack');
    return true;
  } catch (error) {
    // eslint-disable-next-line no-console
...
const updatePackageJsonWithMonorepoScripts = ({ dir }: { dir: string }) => {
  ...
  if (!packageJson.scripts['syncpack:fix']) {
    ...
    // eslint-disable-next-line no-console
    console.log('✓ Added "syncpack:fix" script to package.json');
    updated = true;
  }
  ...
  if (!packageJson.scripts['syncpack:list']) {
    ...
    // eslint-disable-next-line no-console
    console.log('✓ Added "syncpack:list" script to package.json');
    updated = true;
  }
...
export const setupMonorepo = ({ dir }: { dir: string }) => {
  ...
  // eslint-disable-next-line no-console
  console.log(`\n🚀 Setting up monorepo configuration in: ${absoluteDir}\n`);
