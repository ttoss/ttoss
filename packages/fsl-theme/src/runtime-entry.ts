// ---------------------------------------------------------------------------
// @ttoss/fsl-theme/runtime — Framework-agnostic theme runtime + SSR bootstrap
//
...
//   In React apps, prefer <ThemeProvider> from '@ttoss/fsl-theme/react' — it
//   wraps the runtime internally and exposes mode via context hooks.
//
//   @example
//   import { createThemeRuntime } from '@ttoss/fsl-theme/runtime';
