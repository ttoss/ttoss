import { IconType, addIcon } from '@ttoss/react-icons';
...
addIcon('caret-down', caretDownIcon);
addIcon('caret-up', caretUpIcon);
...
addIcon('three-dots-loading', threeDotsLoadingIcon);
...
addIcon('warning-alt', warningAltIcon);
