...
export const OcaTheme: Theme = createTheme(
  {
    colors: {
      ...
      feedback: {
        ...
        border: {
          primary: { default: '#eef9fd', active: '#7dd4e3' },
          secondary: { default: '#465A69', active: '#2d3a47' },
          muted: { default: '#E5E7EB', active: '#bfc5d3' },
          negative: { default: '#ffebec', active: '#ff7578' },
          caution: { default: '#fff8e6', active: '#eead2d' },
          positive: { default: '#e6f6e6', active: '#7cd47c' },
        },
        background: {
          primary: { default: '#eef9fd', active: '#d4eff8' },
          secondary: { default: '#FFFFFF', active: '#f5f5f5' },
          muted: { default: '#F3F4F6', active: '#e5e7eb' },
          negative: { default: '#ffebec', active: '#ffc1c3' },
          caution: { default: '#fff8e6', active: '#ffe6b3' },
          positive: { default: '#e6f6e6', active: '#cce5cc' },
        },
      },
    },
    fonts: {
