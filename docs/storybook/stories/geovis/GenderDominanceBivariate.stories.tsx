...
export const GenderDominanceBivariate: StoryFn<{
  ...
  const spec = React.useMemo(() => {
    ...
    // Add the legend position if the user has specified one. The legend is generated by the mapType, so we need to find it and set its position here.
...
GenderDominanceBivariate.argTypes = {
  ...
  legendPosition: {
    ...
    description: 'Positioned overlay for the gender dominance legend',
  },
};
