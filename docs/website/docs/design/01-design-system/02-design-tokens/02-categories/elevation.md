...
| `elevation.surface.modal`   | dialogs, modal sheets, blocking surfaces | highest surface depth in the normal app flow   | `core.elevation.level.4` |
...
| Dialog or modal sheet         | `elevation.surface.modal`   |
