...
* `core.dataviz` contains primitives specific to analytical visualization:
...
Validation enforces the semantic contract.

### Structural

* semantic tokens must reference valid core tokens
* components must not consume core tokens directly
* no parallel or ad-hoc naming is allowed
