...
In our [Agentic Development Principles](/docs/ai/agentic-development-principles), we call this **[The Corollary of Confidence-Qualified Output](/docs/ai/agentic-development-principles/physics-of-ai-integration#the-corollary-of-confidence-qualified-output)**. But in practice, we just call it **The 80% Rule**.
...
This creates **noise**. Every time you have to verify a low-quality suggestion, you pay a cognitive tax—a direct violation of the **[Principle of Cognitive Bandwidth Conservation](/docs/ai/agentic-development-principles/symbiosis-of-human-ai-agency#the-principle-of-cognitive-bandwidth-conservation)**. You stop trusting the tool.
