...
**In design systems**, it means building components and tokens that preserve [semantic consistency](https://ttoss.dev/docs/design/design-system/) so interfaces do not drift into mixed signals as they scale.
